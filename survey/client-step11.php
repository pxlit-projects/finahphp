...
<form id="form" method="post" action="client-step11-1.php?idc=<?php echo $idPatient; ?>">
	<h2>Belangrijke levensgebeiden</h2>
			<h3>Het volgen van een vorming, training en/of opleiding</h3>
				<div>
					...
					<h4>Hoe ervaar ik dit onderdeel?</h4>
						<div id="radio1">
							...
							<input type="radio" id="ervaarvormingtrainingopleiding4" name="H1a" value="4"><label for="ervaarvormingtrainingopleiding4">Probleem - hinderlijk voor mantelzorger</label>
			   ...
			   <div id="radio2">
				...
				<a href="client-step10-4.php?idc=<?php echo $idPatient; ?>&action=back" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only">VORIGE</a> <input type="submit" id="submit" name="volgende" value="VOLGENDE" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only">
</div> <!-- einde pagina11 -->
</form>
