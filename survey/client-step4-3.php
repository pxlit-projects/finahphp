...
<form id="form" method="post" action="client-step5.php?idc=<?php echo $idPatient; ?>">
			...
			<h3>Omgaan met stressvolle situaties(zoals het autorijden in druk verkeer of het verzorgen van meerdere kinderen)</h3>
				<div>
					...
					<div id="radio1">
						...
						<input type="radio" id="ervaarstressvollesituaties4" name="B4a" value="4"><label for="ervaarstressvollesituaties4">Probleem - hinderlijk voor mantelzorger</label>
			   ...
			   <div id="radio2">
				...
				<a href="client-step4-2.php?idc=<?php echo $idPatient; ?>&action=back" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only">VORIGE</a> <input type="submit" id="submit" name="volgende" value="VOLGENDE" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only">
</div>
</form>
