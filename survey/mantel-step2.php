...
<form id="form" method="post" action="mantel-step2-1.php?idm=<?php echo $idMantel; ?>">
			...
			<h3>Iets nieuws leren (zoals het leren omgaan met bijv. een nieuwe GSM, vaatwasmachine of afstandsbediening; leren ikv een hobby)</h3>
				<div>
					...
					<div id="radio1">
						...
						<input type="radio" id="ervaarietsnieuwsleren4" name="A3a" value="4"><label for="ervaarietsnieuwsleren4">Probleem - hinderlijk voor cliënt</label>
