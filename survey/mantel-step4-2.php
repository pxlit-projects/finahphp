...
<form id="form" method="post" action="mantel-step4-3.php?idm=<?php echo $idMantel; ?>">
			...
			<h3>Ondernemen van complexe taken op eigen initiatief (zoals autorijden, boodschappen doen, uitgebreid koken)</h3>
				<div>
					...
					<div id="radio1">
						...
						<input type="radio" id="ervaarcomplexetaken4" name="B3a" value="4"><label for="ervaarcomplexetaken4">Probleem - hinderlijk voor cliënt</label>
			   ...
			   <div id="radio2">
				...
				<a href="mantel-step4-1.php?idm=<?php echo $idMantel; ?>&action=back" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only">VORIGE</a> <input type="submit" name="volgende" value="VOLGENDE" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only">
</div> <!-- einde pagina4 -->
</form>
