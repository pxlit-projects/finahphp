...
<form id="form" method="post" action="client-step6-2.php?idc=<?php echo $idPatient; ?>">
	<h2>Communicatie</h2>	
			<h3>Schrijven van berichten (bijv. een boodschappenlijstje maken, een e-mail schrijven)</h3>
				<div>
					...
					<h4>Hoe ervaar ik dit onderdeel?</h4>
						<div id="radio1">
							...
							<input type="radio" id="ervaarschrijvenvanboodschappen4" name="C6a" value="4"><label for="ervaarschrijvenvanboodschappen4">Probleem - hinderlijk voor mantelzorger</label>
				...
				<a href="client-step6.php?idc=<?php echo $idPatient; ?>&action=back" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only">VORIGE</a> <input type="submit" id="submit" name="volgende" value="VOLGENDE" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only">
</div> <!-- einde pagina6 -->
</form>
