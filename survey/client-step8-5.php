...
<form id="form" method="post" action="client-step8-6.php?idc=<?php echo $idPatient; ?>">
	<h2>Zelfverzorging</h2>
				...
				<div>
					...
					<h4>Hoe ervaar ik dit onderdeel?</h4>
						<div id="radio1">
							...
							<input type="radio" id="ervaardrinken4" name="E6a" value="4"><label for="ervaardrinken4">Probleem - hinderlijk voor mantelzorger</label>
		...
		<a href="client-step8-4.php?idc=<?php echo $idPatient; ?>&action=back" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only">VORIGE</a> <input type="submit" id="submit" name="volgende" value="VOLGENDE" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only">
</div> <!-- einde pagina8 -->
</form>
