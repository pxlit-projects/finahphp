...
<form id="form" method="post" action="client-step8.php?idc=<?php echo $idPatient; ?>">
	<h2>Mobiliteit</h2>
			<h3>Besturen van vervoermiddel (zoals de auto of de fiets)</h3>
				<div>
					...
					<h4>Hoe ervaar ik dit onderdeel?</h4>
						<div id="radio1">
							...
							<input type="radio" id="ervaarbesturenvanvervoersmiddel4" name="D5a" value="4"><label for="ervaarbesturenvanvervoersmiddel4">Probleem - hinderlijk voor mantelzorger</label>
			   ...
			   <div id="radio2">
				...
				<a href="client-step7-3.php?idc=<?php echo $idPatient; ?>&action=back" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only">VORIGE</a> <input type="submit" id="submit" name="volgende" value="VOLGENDE" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only">
</div> <!-- einde pagina7 -->
</form>
