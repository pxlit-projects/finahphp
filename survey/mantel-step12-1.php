...
<form id="form" method="post" action="mantel-step12-2.php?idm=<?php echo $idMantel; ?>">
	<h2>Maatschappelijk, sociaal en burgerlijk leven</h2>
			<h3>Ontspanning en vrije tijd (activiteiten gericht op amusement)</h3>
				<div>
					...
					<h4>Hoe ervaar ik dit onderdeel?</h4>
						<div id="radio1">
							...
							<input type="radio" id="ervaarontspanningvrijetijd4" name="I2a" value="4"><label for="ervaarontspanningvrijetijd4">Probleem - hinderlijk voor cliënt</label>
			   ...
			   <div id="radio2">
				...
				<a href="mantel-step12.php?idm=<?php echo $idMantel; ?>&action=back" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only">VORIGE</a> <input type="submit" name="volgende" value="VOLGENDE" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only">
</div>
</form>
