...
<form id="form" method="post" action="mantel-step14.php?idm=<?php echo $idMantel; ?>">
	<h2>Emotie en gedrag</h2>
			<h3>Sneller emotioneel (bijv. huilen)</h3>
				<div>
					<h4>Hoe ervaar ik dit onderdeel?</h4>
						<div id="radio1">
							...
							<input type="radio" id="ervaarsnelleremotioneel4" name="J4a" value="4"><label for="ervaarsnelleremotioneel4">Probleem - hinderlijk voor cliënt</label>
		...
		<a href="mantel-step13-2.php?idm=<?php echo $idMantel; ?>&action=back" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only">VORIGE</a> <input type="submit" name="volgende" value="VOLGENDE" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only">	
</div> <!-- einde pagina13 -->
</form>
