...
<form id="form" method="post" action="mantel-step10-3.php?idm=<?php echo $idMantel; ?>">
	<h2>Omgaan met andere mensen</h2>
			<h3>Omgaan met familieleden</h3>
				<div>
					...
					<h4>Hoe ervaar ik dit onderdeel?</h4>
						<div id="radio1">
							...
							<input type="radio" id="ervaaromgaanfamilieleden4" name="G3a" value="4"><label for="ervaaromgaanfamilieleden4">Probleem - hinderlijk voor cliënt</label>
			   ...
			   <div id="radio2">
				...
				<a href="mantel-step10-1.php?idm=<?php echo $idMantel; ?>&action=back" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only">VORIGE</a> <input type="submit" name="volgende" value="VOLGENDE" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only">
</div> <!-- einde pagina10 -->
</form>
