...
<form id="form" method="post" action="mantel-step3.php?idm=<?php echo $idMantel; ?>">
	<h2>Leren en toepassen van kennis</h2>
			<h3>Denken (zoals fantaseren, een mening vormen, met ideeën spelen, of nadenken)</h3>
				<div>
					...
					<div id="radio1">
						...
						<input type="radio" id="ervaardenken4" name="A5a" value="4"><label for="ervaardenken4">Probleem - hinderlijk voor cliënt</label>
		...
		<a href="mantel-step2-1.php?idm=<?php echo $idMantel; ?>&action=back" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only">VORIGE</a> <input type="submit" name="volgende" value="VOLGENDE" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only">
</div> <!-- einde pagina2 -->
</form>
