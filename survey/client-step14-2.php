...
<form id="form" method="post" action="client-step14-3.php?idc=<?php echo $idPatient; ?>">
	<h2>Emotie en gedrag</h2>
			<h3>Ontremming en problemen met controle van gedrag</h3>
				<div>
					<h4>Hoe ervaar ik dit onderdeel?</h4>
						<div id="radio1">
							...
							<input type="radio" id="ervaarontremmingproblemencontrolegedrag4" name="J7a" value="4"><label for="ervaarontremmingproblemencontrolegedrag4">Probleem - hinderlijk voor mantelzorger</label>
			   ...
			   <br>
				...
				<a href="client-step14-1.php?idc=<?php echo $idPatient; ?>&action=back" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only">VORIGE</a> <input type="submit" id="submit" name="volgende" value="VOLGENDE" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only">
</div> <!-- einde pagina14 -->     
</form>
