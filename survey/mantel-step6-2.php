...
<form id="form" method="post" action="mantel-step6-3.php?idm=<?php echo $idMantel; ?>">
	<h2>Communicatie</h2>
			<h3>Het voeren van een gesprek</h3>
				<div>
					...
					<h4>Hoe ervaar ik dit onderdeel?</h4>
						<div id="radio1">
							...
							<input type="radio" id="ervaarvoerenvangesprek4" name="C7a" value="4"><label for="ervaarvoerenvangesprek4">Probleem - hinderlijk voor cliënt</label>
				...
				<a href="mantel-step6-1.php?idm=<?php echo $idMantel; ?>&action=back" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only">VORIGE</a> <input type="submit" name="volgende" value="VOLGENDE" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only">
</div> <!-- einde pagina6 -->
</form>
