...
<form id="form" method="post" action="mantel-step14-1.php?idm=<?php echo $idMantel; ?>">
				...
				<div>
					<h4>Hoe ervaar ik dit onderdeel?</h4>
						<div id="radio1">
							...
							<input type="radio" id="ervaarsnellergeirriteerdenprikkelbaar4" name="J5a" value="4"><label for="ervaarsnellergeirriteerdenprikkelbaar4">Probleem - hinderlijk voor cliënt</label>
...
<a href="mantel-step13-3.php?idm=<?php echo $idMantel; ?>&action=back" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only">VORIGE</a> <input type="submit" name="volgende" value="VOLGENDE" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only">
</div> <!-- einde pagina14 -->        
</form>
