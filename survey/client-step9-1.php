...
<form id="form" method="post" action="client-step9-2.php?idc=<?php echo $idPatient; ?>">
	<h2>Huishouden</h2>
			<h3>Bereiden van maaltijden</h3>
				<div>
					...
					<h4>Hoe ervaar ik dit onderdeel?</h4>
						<div id="radio1">
							...
							<input type="radio" id="ervaarbereidenmaaltijden4" name="F2a" value="4"><label for="ervaarbereidenmaaltijden4">Probleem - hinderlijk voor mantelzorger</label>
			   ...
			   <div id="radio2">
				...
				<a href="client-step9.php?idc=<?php echo $idPatient; ?>&action=back" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only">VORIGE</a> <input type="submit" id="submit" name="volgende" value="VOLGENDE" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only">
</div> <!-- einde pagina9 -->			
</form>
