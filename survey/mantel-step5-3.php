...
<form id="form" method="post" action="mantel-step6.php?idm=<?php echo $idMantel; ?>">
	<h2>Communicatie</h2>
			<h3>Spreken</h3>
				<div>
					...
					<h4>Hoe ervaar ik dit onderdeel?</h4>
						<div id="radio1">
							...
							<input type="radio" id="ervaarspreken3" name="C4a" value="3"><label for="ervaarspreken3">Er is een probleem dat enkel hinderlijk is voor de mantelzorger</label>
							<input type="radio" id="ervaarspreken4" name="C4a" value="4"><label for="ervaarspreken4">Probleem - hinderlijk voor cliënt</label>
		...
		<a href="mantel-step5-2.php?idm=<?php echo $idMantel; ?>&action=back" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only">VORIGE</a> <input type="submit" name="volgende" value="VOLGENDE" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only">
</div> <!-- einde pagina5 -->
</form>
