...
<form id="form" method="post" action="mantel-step5-1.php?idm=<?php echo $idMantel; ?>">
	<h2>Communicatie</h2>
				...
				<div>
					...
					<h4>Hoe ervaar ik dit onderdeel?</h4>
						<div id="radio1">
							...
							<input type="radio" id="ervaarbegrijpenvertellenvragen3" name="C1a" value="3"><label for="ervaarbegrijpenvertellenvragen3">Er is een probleem dat enkel hinderlijk is voor de mantelzorger</label>
							<input type="radio" id="ervaarbegrijpenvertellenvragen4" name="C1a" value="4"><label for="ervaarbegrijpenvertellenvragen4">Probleem - hinderlijk voor cliënt</label>
		...
		<a href="mantel-step4-3.php?idm=<?php echo $idMantel; ?>&action=back" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only">VORIGE</a> <input type="submit" name="volgende" value="VOLGENDE" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only">
</div> <!-- einde pagina5 -->
</form>
