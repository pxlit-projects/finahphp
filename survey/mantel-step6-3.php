...
$labelB = "hieraanwerkencommunicatieapptechnologie1";
include("headerscriptsmantel.php");
?>
</head><body>
<div id="pagina6">
<p align="center"><progress value="19" max="53"></progress></p>
<form id="form" method="post" action="mantel-step7.php?idm=<?php echo $idMantel; ?>">
	<h2>Communicatie</h2>
			<h3>Gebruiken van communicatieapparatuur en -technieken (zoals gebruik van telefoon, GSM, computer, hoorapparaat, etc)</h3>
				<div>
					...
					<h4>Hoe ervaar ik dit onderdeel?</h4>
						<div id="radio1">
							...
							<input type="radio" id="ervaarcommunicatieapptechnologie4" name="C8a" value="4"><label for="ervaarcommunicatieapptechnologie4">Probleem - hinderlijk voor cliënt</label>
				...
				<a href="mantel-step6-2.php?idm=<?php echo $idMantel; ?>&action=back" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only">VORIGE</a> <input type="submit" name="volgende" value="VOLGENDE" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only">
</div> <!-- einde pagina6 -->
</form>
