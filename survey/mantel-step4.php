...
<form id="form" method="post" action="mantel-step4-1.php?idm=<?php echo $idMantel; ?>">
			...
			<h3>Uitvoeren  van dagelijkse routinehandelingen (zoals zich wassen, ontbijten)</h3>
				<div>
					...
					<div id="radio1">
						...
						<input type="radio" id="ervaardagelijkseroutine4" name="B1a" value="4"><label for="ervaardagelijkseroutine4">Probleem - hinderlijk voor cliënt</label>
			   ...
			   <div id="radio2">
				...
				<a href="mantel-step3-3.php?idm=<?php echo $idMantel; ?>&action=back" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only">VORIGE</a> <input type="submit" name="volgende" value="VOLGENDE" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only">
</div> <!-- einde pagina4 -->
</form>
