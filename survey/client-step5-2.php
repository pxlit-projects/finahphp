...
<form id="form" method="post" action="client-step5-3.php?idc=<?php echo $idPatient; ?>">
	<h2>Communicatie</h2>
				...
				<div>
					...
					<h4>Hoe ervaar ik dit onderdeel?</h4>
						<div id="radio1">
							...
							<input type="radio" id="ervaarbegrijpengeschrevenboodschappen3" name="C3a" value="3"><label for="ervaarbegrijpengeschrevenboodschappen3">Probleem - hinderlijk voor mij</label>
							<input type="radio" id="ervaarbegrijpengeschrevenboodschappen4" name="C3a" value="4"><label for="ervaarbegrijpengeschrevenboodschappen4">Probleem - hinderlijk voor mantelzorger</label>
		...
		<a href="client-step5-1.php?idc=<?php echo $idPatient; ?>&action=back" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only">VORIGE</a> <input type="submit" id="submit" name="volgende" value="VOLGENDE" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only">
</div> <!-- einde pagina5 -->
</form>
