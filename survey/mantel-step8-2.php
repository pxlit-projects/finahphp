...
<form id="form" method="post" action="mantel-step8-3.php?idm=<?php echo $idMantel; ?>">
	<h2>Zelfverzorging</h2>
			<h3>Zelfstandig naar het toilet kunnen gaan</h3>
				<div>
					...
					<h4>Hoe ervaar ik dit onderdeel?</h4>
						<div id="radio1">
							...
							<input type="radio" id="ervaarzelfstandigtoiletgaan4" name="E3a" value="4"><label for="ervaarzelfstandigtoiletgaan4">Probleem - hinderlijk voor cliënt</label>
			   ...
			   <div id="radio2">
				...
				<a href="mantel-step8-1.php?idm=<?php echo $idMantel; ?>&action=back" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only">VORIGE</a> <input type="submit" name="volgende" value="VOLGENDE" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only">
</div> <!-- einde pagina8 -->
</form>
