...
<form id="form" method="post" action="mantel-step9-1.php?idm=<?php echo $idMantel; ?>">
	<h2>Huishouden</h2>
			<h3>Gaan winkelen</h3>
				<div>
					...
					<h4>Hoe ervaar ik dit onderdeel?</h4>
						<div id="radio1">
							...
							<input type="radio" id="ervaargaanwinkelen4" name="F1a" value="4"><label for="ervaargaanwinkelen4">Probleem - hinderlijk voor cliënt</label>
			   ...
			   <div id="radio2">
				...
				<a href="mantel-step8-6.php?idm=<?php echo $idMantel; ?>&action=back" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only">VORIGE</a> <input type="submit" name="volgende" value="VOLGENDE" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only">
</div> <!-- einde pagina9 -->			
</form>
