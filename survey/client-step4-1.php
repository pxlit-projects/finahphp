...
<form id="form" method="post" action="client-step4-2.php?idc=<?php echo $idPatient; ?>">
		...
		<h3>Ondernemen van een eenvoudige taak op eigen initiatief (zoals een boodschappenlijstje opmaken, de vuilzak buitenzetten, de tafel dekken)</h3>
				<div>
					...
					<div id="radio1">
						...
						<input type="radio" id="ervaareenvoudigetaak4" name="B2a" value="4"><label for="ervaareenvoudigetaak4">Probleem - hinderlijk voor mantelzorger</label>
			   ...
			   <div id="radio2">
				...
				<a href="client-step4.php?idc=<?php echo $idPatient; ?>&action=back" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only">VORIGE</a> <input type="submit" id="submit" name="volgende" value="VOLGENDE" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only">
</div> <!-- einde pagina4 -->
</form>
