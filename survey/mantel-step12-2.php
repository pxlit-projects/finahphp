...
<form id="form" method="post" action="mantel-step13.php?idm=<?php echo $idMantel; ?>">
	<h2>Maatschappelijk, sociaal en burgerlijk leven</h2>
			<h3>Religie en spiritualiteit</h3>
				<div>
					...
					<h4>Hoe ervaar ik dit onderdeel?</h4>
						<div id="radio1">
							...
							<input type="radio" id="ervaarreligiespiritualiteit4" name="I3a" value="4"><label for="ervaarreligiespiritualiteit4">Probleem - hinderlijk voor cliënt</label>
			   ...
			   <div id="radio2">
				...
				<a href="mantel-step12-1.php?idm=<?php echo $idMantel; ?>&action=back" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only">VORIGE</a> <input type="submit" name="volgende" value="VOLGENDE" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only">
</div> <!-- einde pagina12 -->
</form>
