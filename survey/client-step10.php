...
<form id="form" method="post" action="client-step10-1.php?idc=<?php echo $idPatient; ?>">
	<h2>Omgaan met andere mensen</h2>
			<h3>Op sociaal gepaste wijze contact maken met bekende en onbekende mensen (respectvol, rekening houden met de situatie, etc.)</h3>
				<div>
					...
					<h4>Hoe ervaar ik dit onderdeel?</h4>
						<div id="radio1">
							...
							<input type="radio" id="ervaarsociaalgepastewijzecontact4" name="G1a" value="4"><label for="ervaarsociaalgepastewijzecontact4">Probleem - hinderlijk voor mantelzorger</label>
			   ...
			   <div id="radio2">
				...
				<a href="client-step9-2.php?idc=<?php echo $idPatient; ?>&action=back" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only">VORIGE</a> <input type="submit" id="submit" name="volgende" value="VOLGENDE" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only">
</div> <!-- einde pagina10 -->
</form>
