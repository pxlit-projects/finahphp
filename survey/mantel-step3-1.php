...
<form id="form" method="post" action="mantel-step3-2.php?idm=<?php echo $idMantel; ?>">
			...
			<h3>Rekenen (zoals gepast betalen bij een winkel)</h3>
				<div>
					...
					<div id="radio1">
						...
						<input type="radio" id="ervaarrekenen4" name="A8a" value="4"><label for="ervaarrekenen4">Probleem - hinderlijk voor cliënt</label>
			   ...
			   <div id="radio2">
				...
				<a href="mantel-step3.php?idm=<?php echo $idMantel; ?>&action=back" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only">VORIGE</a> <input type="submit" name="volgende" value="VOLGENDE" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only">
</div> <!-- einde pagina3 -->
</form>
