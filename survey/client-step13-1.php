...
<form id="form" method="post" action="client-step13-2.php?idc=<?php echo $idPatient; ?>">
	<h2>Emotie en gedrag</h2>
				...
				<div>
					<h4>Hoe ervaar ik dit onderdeel?</h4>
						<div id="radio1">
							...
							<input type="radio" id="ervaarangstgevoelens4" name="J2a" value="4"><label for="ervaarangstgevoelens4">Probleem - hinderlijk voor mantelzorger</label>
		...
		<a href="client-step13.php?idc=<?php echo $idPatient; ?>&action=back" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only">VORIGE</a> <input type="submit" id="submit" name="volgende" value="VOLGENDE" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only">
</div>
</form>
