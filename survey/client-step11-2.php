...
<form id="form" method="post" action="client-step12.php?idc=<?php echo $idPatient; ?>">
	<h2>Belangrijke levensgebeiden</h2>
			<h3>Financiële mogelijkheden voor jezelf en je gezin</h3>
				<div>
					...
					<h4>Hoe ervaar ik dit onderdeel?</h4>
						<div id="radio1">
							...
							<input type="radio" id="ervaarfinancielemogelijkheden4" name="H3a" value="4"><label for="ervaarfinancielemogelijkheden4">Probleem - hinderlijk voor mantelzorger</label>
			   ...
			   <div id="radio2">
				...
				<a href="client-step11-1.php?idc=<?php echo $idPatient; ?>&action=back" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only">VORIGE</a> <input type="submit" id="submit" name="volgende" value="VOLGENDE" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only">
</div>
</form>
