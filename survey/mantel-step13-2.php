...
<form id="form" method="post" action="mantel-step13-3.php?idm=<?php echo $idMantel; ?>">
	<h2>Emotie en gedrag</h2>
				...
				<div>
					<h4>Hoe ervaar ik dit onderdeel?</h4>
						<div id="radio1">
							...
							<input type="radio" id="ervaaronrealistischeverwachtingen4" name="J3a" value="4"><label for="ervaaronrealistischeverwachtingen4">Probleem - hinderlijk voor cliënt</label>
		...
		<a href="mantel-step13-1.php?idm=<?php echo $idMantel; ?>&action=back" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only">VORIGE</a> <input type="submit" name="volgende" value="VOLGENDE" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only">	
</div> <!-- einde pagina13 -->
</form>
