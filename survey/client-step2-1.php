...
<form id="form" method="post" action="client-step2-2.php?idc=<?php echo $idPatient; ?>">
			...
			<h3>Zich kunnen concentreren zonder te worden afgeleid (zoals het volgen van een gesprek in een drukke omgeving, of het volgen van een Tv-programma)</h3>
				<div>
					...
					<div id="radio1">
						...
						<input type="radio" id="ervaarconcentreren4" name="A4a" value="4"><label for="ervaarconcentreren4">Probleem - hinderlijk voor mantelzorger</label>
			   ...
			   <div id="radio2">
					...
					<br>
<a href="client-step2.php?idc=<?php echo $idPatient; ?>&action=back" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only">VORIGE</a> <input type="submit" id="submit" name="volgende" value="VOLGENDE" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only">
			</div>
</div>
</form>
