...
<form id="form" method="post" action="mantel-step9.php?idm=<?php echo $idMantel; ?>">
	<h2>Zelfverzorging</h2>
			<h3>Letten op de gezondheid (gevarieerd eten, voldoende lichaamsbeweging, gezondheidsrisico's vermijden)</h3>
				<div>
					...
					<h4>Hoe ervaar ik dit onderdeel?</h4>
						<div id="radio1">
							...
							<input type="radio" id="ervaarlettenopgezondheid4" name="E7a" value="4"><label for="ervaarlettenopgezondheid4">Probleem - hinderlijk voor cliënt</label>
			   ...
			   <div id="radio2">
				...
				<a href="mantel-step8-5.php?idm=<?php echo $idMantel; ?>&action=back" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only">VORIGE</a> <input type="submit" name="volgende" value="VOLGENDE" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only">
</div> <!-- einde pagina8 -->
</form>
