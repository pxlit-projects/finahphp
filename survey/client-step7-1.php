...
<form id="form" method="post" action="client-step7-2.php?idc=<?php echo $idPatient; ?>">
	<h2>Mobiliteit</h2>
			<h3>Gebruiken van hand en arm (grote bewegingen, zoals voorwerpen optillen en meenemen)</h3>
				<div>
					...
					<h4>Hoe ervaar ik dit onderdeel?</h4>
						<div id="radio1">
							...
							<input type="radio" id="ervaargebruikhandenarm4" name="D2a" value="4"><label for="ervaargebruikhandenarm4">Probleem - hinderlijk voor mantelzorger</label>
				...
				<a href="client-step7.php?idc=<?php echo $idPatient; ?>&action=back" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only">VORIGE</a> <input type="submit" id="submit" name="volgende" value="VOLGENDE" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only">
</div> <!-- einde pagina7 -->
</form>
