...
<form id="form" method="post" action="mantel-step12-1.php?idm=<?php echo $idMantel; ?>">
	<h2>Maatschappelijk, sociaal en burgerlijk leven</h2>
			<h3>Deelnemen aan het maatschappelijk leven</h3>
				<div>
					...
					<h4>Hoe ervaar ik dit onderdeel?</h4>
						<div id="radio1">
							...
							<input type="radio" id="ervaardeelnemenmaatschappelijkleven4" name="I1a" value="4"><label for="ervaardeelnemenmaatschappelijkleven4">Probleem - hinderlijk voor cliënt</label>
			   ...
			   <div id="radio2">
				...
				<a href="mantel-step11-2.php?idm=<?php echo $idMantel; ?>&action=back" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only">VORIGE</a> <input type="submit" name="volgende" value="VOLGENDE" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only">
</div> <!-- einde pagina12 -->
</form>
