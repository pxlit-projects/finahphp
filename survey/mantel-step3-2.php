...
<form id="form" method="post" action="mantel-step3-3.php?idm=<?php echo $idMantel; ?>">
			...
			<h3>Oplossen van problemen (zoals een afspraak bij de dokter verzetten, of weten wat je moet doen als er iets stuk gaat in huis)</h3>
				<div>
					...
					<div id="radio1">
						...
						<input type="radio" id="ervaaroplossenvanproblemen4" name="A9a" value="4"><label for="ervaaroplossenvanproblemen4">Probleem - hinderlijk voor cliënt</label>
			   ...
			   <div id="radio2">
				...
				<a href="mantel-step3-1.php?idm=<?php echo $idMantel; ?>&action=back" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only">VORIGE</a> <input type="submit" name="volgende" value="VOLGENDE" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only">
</div> <!-- einde pagina3 -->
</form>
